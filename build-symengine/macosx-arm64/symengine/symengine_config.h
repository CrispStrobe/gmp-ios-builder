...
#define SYMENGINE_PATCH_VERSION 2
#define SYMENGINE_VERSION "0.11.2"
...
#define SYMENGINE_INTEGER_CLASS SYMENGINE_FLINT

#define SYMENGINE_SIZEOF_LONG_DOUBLE 8
