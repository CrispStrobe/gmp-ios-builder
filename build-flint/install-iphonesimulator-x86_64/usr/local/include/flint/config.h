...
#define PACKAGE_STRING "FLINT 3.3.1"
...
#define DIAGNOSTIC_IGNORE_INCOMPATIBLE_FUNCTION_POINTER_TYPES _Pragma("clang diagnostic ignored \"-Wincompatible-function-pointer-types\"")
...
#define DIAGNOSTIC_IGNORE_CAST_FUNCTION_TYPE _Pragma("clang diagnostic ignored \"-Wcast-function-type\"")
#define DIAGNOSTIC_IGNORE_OVERLENGTH_STRINGS _Pragma("clang diagnostic ignored \"-Woverlength-strings\"")
#define DIAGNOSTIC_IGNORE_UNUSED_VARIABLE _Pragma("clang diagnostic ignored \"-Wunused-variable\"")
